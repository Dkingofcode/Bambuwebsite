...
export default function FounderVision() {
  return (
    <section className="bg-[#325432] py-20 md:py-28 relative overflow-hidden">
      <div className="container-max gap-2  p-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center p-12">
          ...
          <div className="space-y-8">
            {/* Large Quote */}
            <div>
              <h2 className="text-5xl md:text-6xl font-poppins font-bold text-[#E7B621] leading-tight">
            ...
            <div className="pt-8 border-t border-white/20">
              <p className="text-[#E7B621] font-poppins font-bold text-xl mb-2">
                Morenike Olaolu
              </p>
