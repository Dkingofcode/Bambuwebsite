    ...
    <section className="bg-[#D9DECC] py-20 md:py-28">
      <div className="container-max">
        ...
        <div className="markaworks-portfolio-gallery-wrapper relative w-full h-96" ref={sectionRef}>
          <div className="markaworks-gallery-nav markaworks-gallery-nav-left absolute left-0 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-[#E7B621] text-[#1a3a3a] flex items-center justify-center">
          ...
          <div className="markaworks-gallery-nav markaworks-gallery-nav-right absolute right-0 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-[#E7B621] text-[#1a3a3a] flex items-center justify-center">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
