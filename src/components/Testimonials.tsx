      ...
      <div className="container-max">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <h3 className="text-3xl md:text-4xl font-poppins font-bold text-[#052F23]">
              {current.title}
            </h3>
            ...
            <div className="flex items-center gap-4 pt-8 border-t border-gray-300">
              ...
              />
              <div>
                <p className="font-poppins font-bold text-[#052F23]">{current.author}</p>
            ...
            <div className="flex gap-4 pt-4">
              <button
                onClick={handlePrev}
                className="w-12 h-12 rounded-full border border-gray-300 text-[#052F23] hover:border-[#E7B621] hover:text-[#E7B621] transition-all duration-300 flex items-center justify-center"
