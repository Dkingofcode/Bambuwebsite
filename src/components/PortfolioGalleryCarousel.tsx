        ...
        <div className="relative">
          ...
          <div className="flex items-center justify-between mt-8">
            <div className="flex gap-4">
              <button
                onClick={handlePrev}
                className="w-12 h-12 rounded-full border-2 border-[#1a3a3a] text-[#1a3a3a] flex items-center justify-center hover:bg-[#1a3a3a] hover:text-white transition-all duration-300"
            ...
            {/* Counter */}
            <div className="text-sm font-semibold text-[#1a3a3a]">
