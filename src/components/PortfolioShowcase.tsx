        ...
        <div className="mb-12">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
            <div className="flex gap-4 items-center">
              <a href="/projects/" className="px-6 py-2 bg-white text-[#052F23] font-poppins font-semibold rounded-lg hover:bg-gray-100 transition-all duration-300">
                View all
              </a>
                    ...
                    {categories.map((category) => (
                      <button
                        ...
                        className={`w-full px-6 py-3 text-left flex justify-between items-center hover:bg-white/10 transition-all ${
                          activeCategory === category.value ? 'bg-[#E7B621] text-[#052F23]' : 'text-white'
                        }`}
                      >
