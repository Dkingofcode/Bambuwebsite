  ...
  return (
    <section className="bg-[#D9DECC] py-20 md:py-28">
      <div className="container-max">
        {/* Header */}
        <div className="mb-16">
          <h2 className="text-5xl md:text-6xl font-poppins font-bold text-[#052F23] mb-6 leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {methodologySteps.map((step, idx) => (
            ...
            >
              {/* Step Number */}
              <div className="text-6xl font-poppins font-bold text-[#052F23] mb-6 opacity-20">
                {step.number}
              </div>

              {/* Title */}
              <h3 className="text-2xl font-poppins font-bold text-[#052F23] mb-4">
                {step.title}
              </h3>
